...
#define GLOOST_MOUSESTATE_BUTTON0 0
#define GLOOST_MOUSESTATE_BUTTON1 1
#define GLOOST_MOUSESTATE_BUTTON2 2
#define GLOOST_MOUSESTATE_BUTTON3 3
#define GLOOST_MOUSESTATE_BUTTON4 4
#define GLOOST_MOUSESTATE_BUTTON5 5
#define GLOOST_MOUSESTATE_BUTTON6 6

#define GLOOST_MOUSESTATE_WHEELUP   7
#define GLOOST_MOUSESTATE_WHEELDOWN 8
...
class MouseState
{
    ...
    bool getButtonDownEvent(unsigned int buttonNum) const;
    void setButtonDownEvent(unsigned int buttonNum, bool eventToggle);

    bool getButtonUpEvent(unsigned int buttonNum) const;
    void setButtonUpEvent(unsigned int buttonNum, bool eventToggle);
