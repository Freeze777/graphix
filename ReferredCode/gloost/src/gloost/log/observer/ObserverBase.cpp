...
/*virtual*/
void
ObserverBase::onBegin (const std::shared_ptr<Log>& log)
{
...
/*virtual*/
void
ObserverBase::onPostMessage (const std::shared_ptr<const Message>& message)
{
...
/*virtual*/
void
ObserverBase::onEnd (const std::shared_ptr<Log>& log)
{
