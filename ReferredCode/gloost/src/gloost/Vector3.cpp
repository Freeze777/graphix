...
Vector3::compressAsNormal(const Vector3& vector, unsigned char fourthByte)
{
  ...
  gloost::packRgbaToUnsigned(packedNormal, nx8, ny8, nz8, fourthByte);
  return packedNormal;
}
...
Vector3::uncompressAsNormal(unsigned value)
{
  ...
  gloost::unpackRgbaFromUnsigned(value, nx, ny, nz, empty);
...
Vector3::compressAsColor(const Vector3& vector, unsigned char fourthByte)
{
  ...
  gloost::packRgbaToUnsigned(packedColor, red8, green8, blue8, fourthByte);
...
Vector3::uncompressAsColor(unsigned value)
{
  ...
  Vector3 v3;
  gloost::unpackRgbaFromUnsigned(value, r, g, b, empty);
