...
#ifndef H_GLOOST_UNIFORMTYPES
#define H_GLOOST_UNIFORMTYPES
...
//    a = 0.0;
  ...
  vec4(const vec3& v, float a_value)
  {
    r = v.x;
    g = v.y;
    b = v.z;
  ...
  vec4(float r_value, float g_value, float b_value, float a_value = 1.0)
  {
    r = r_value;
    g = g_value;
    b = b_value;
  ...
  vec4(const Vector3& v, float a_value)
  {
    r = v[0];
    g = v[1];
    b = v[2];
  ...
  vec4(const Point3& p, float a_value)
  {
    r = p[0];
    g = p[1];
    b = p[2];
  ...
  vec4 operator*(mathType factor)
  {
    return vec4(r*factor, g*factor, b*factor, a*factor);
  }
...
//
///// vec4 * mathType
//extern void operator=(const vec3& v3, const vec4& v4 ){v3.x = v4.r; v3.y = v4.g; v3.z = v4.b;}
