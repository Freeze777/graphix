...
void inline stringExplode(const std::string&        aString,
...
{
  const std::string withZeros = toString(value, 16);
...
#define GLOOST_CURRENT_LOCATION __PRETTY_FUNCTION__  + std::string(" @ Line: ") +  gloost::toString(__LINE__)
